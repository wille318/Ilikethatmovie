...
public class Horror4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.horror4);
        ...
        backImg = getResources().getDrawable(R.drawable.horror4);
        backImg.setAlpha(80);
        linearLayout.setBackground(backImg);


        Intent c = getIntent();
        Intent d= new Intent(Horror4.this, Horror5.class);
