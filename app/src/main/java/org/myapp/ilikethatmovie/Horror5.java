...
public class Horror5 extends AppCompatActivity {
    TextView textResult;
    TextView result_tv;
    Button answer1;
    int finalSum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.horror5);
...
//                    result_tv.setText("결과가 4점 ~ 7점인 경우에는 1구간을 추천합니당");
                    Intent intent = new Intent(Horror5.this,Hor_A4.class);
                    startActivity(intent);
                }
                else if(finalSum <=10) {
//                    result_tv.setText("결과가 8점 ~ 10점인 경우에는 2구간을 추천합니당");
                    Intent intent = new Intent(Horror5.this, Hor_A3.class);
                    startActivity(intent);
                }
                else if(finalSum <=13){
//                    result_tv.setText("결과가 11점 ~ 13점인 경우에는 3구간을 추천합니당");
                    Intent intent = new Intent(Horror5.this, Hor_A2.class);
                    startActivity(intent);

                }
                else{
//                    result_tv.setText("결과가 14점~16점인 경우 4구간을 추천합니다ㅏ");
                    Intent intent = new Intent(Horror5.this, Hor_A1.class);
                    startActivity(intent);
                }
            }
        });
